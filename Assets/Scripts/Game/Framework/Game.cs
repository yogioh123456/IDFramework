...
public partial class Game : EntityStatic
{
    ...
    public static void Init() {
        ...
        AddComp<MainLogic>();
        AddComp<SaveLoadManager>();
        AddComp<LanguageManager>();
        AddComp<AudioManager>();
        //AddComp<SteamManager>();

        //--------logic----------
        AddComp<BuffManagerClient>();
    }
    
    public static void AddServerComp() {
        AddComp<KCPServerManager>();
        AddComp<KCPServerLogic>();
        AddComp<ServerSyncManager>();
        AddComp<ServerNetwork>();
        AddComp<ServerMainLogic>();
    }
